class Usuario < ActiveRecord::Base
  ...
  validates :username, presence: true, uniqueness: true, 
  			length: {in: 5..20, too_short: "Tiene que tener al menos 5 carateres", too_long: "Maximo 20 caracteres"},
  			format: {with: /([A-Za-z0-9\-\_]+)/, message: "Username solo puede contener letras, números y guiones"}
